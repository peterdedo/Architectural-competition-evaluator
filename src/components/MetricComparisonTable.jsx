...
const METRICS = [
  ...
  { id: 'nezpevnena', label: 'Nezpevněná (propustná) plocha', unit: 'm²', get: (d) => safeNum(d.bilance_nezpevnena) },
  ...
  { id: 'obestaveny_celkem', label: 'Obestavěný prostor celkem', unit: 'm³', get: (d) => computeDerivedField('obestaveny_celkem', d) },
  ...
  { id: 'obalka', label: 'Obálka budovy', unit: 'm²', get: (d) => computeDerivedField('obalka_celkem', d) },
  { id: 'proskleni', label: 'Podíl prosklení', unit: '%', get: (d) => asPercent(computeDerivedField('proskleni_podil', d)) },
  { id: 'demolice', label: 'Demolice', unit: 'm³', get: (d) => computeDerivedField('demolice_celkem', d) },
  { id: 'hpp', label: 'HPP celkem', unit: 'm²', get: (d) => floorsTotal(d.hpp) },
  { id: 'uzitna', label: 'Užitná plocha celkem', unit: 'm²', get: (d) => floorsTotal(d.uzitna) },
