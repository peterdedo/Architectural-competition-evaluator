...
import { getAllIndicators } from '../utils/indicatorManager.js';
import { calculateAllScores, getScoringExplanation } from '../engine/EvaluationEngine.js';
import { BarChart3, File, Trophy, ArrowRight, Edit3, Save, Info, TrendingUp } from 'lucide-react';
...
const StepResults = ({ navrhy, vybraneIndikatory, onNext, onBack, setNavrhy }) => {
  ...
  const scoredProposals = useMemo(() => {
    if (!navrhy || navrhy.length === 0) return [];
    return calculateAllScores(navrhy, vybraneIndikatory);
  }, [navrhy, vybraneIndikatory]);
      ...
      <div className="p-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {scoredProposals.map(navrh => {
            ...
            const weightedScore = navrh.weightedScore || 0;
                ...
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      <div className="bg-gradient-to-r from-[#0066A4] to-[#4BB349] text-white px-2 py-1 rounded-full text-xs font-semibold">
                        Skóre: {weightedScore}%
                      </div>
                    </div>
                  </div>
