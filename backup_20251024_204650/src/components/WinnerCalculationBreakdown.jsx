        ...
        vybraneIndikatoryList.forEach(indikator => {
          ...
          if (actualValue !== null && actualValue !== undefined) {
            ...
            detailedScores.push({
              ...
              hodnota: actualValue,
              weight: weight,
              categoryWeight: categoryWeights[indikator.kategorie] || (100 / Object.keys(categoryWeights).length),
              finalWeight: (weight * (categoryWeights[indikator.kategorie] || (100 / Object.keys(categoryWeights).length))) / 100,
