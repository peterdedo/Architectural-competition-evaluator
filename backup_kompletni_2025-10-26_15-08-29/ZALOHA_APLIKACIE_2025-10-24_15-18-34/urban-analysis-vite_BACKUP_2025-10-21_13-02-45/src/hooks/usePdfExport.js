...
const usePdfExport = () => {
  ...
  const generatePdfReport = useCallback(async (data) => {
    ...
    try {
      ...
      doc.setFillColor(0, 102, 164); // Modrá
      doc.rect(0, 0, pageWidth, 30, 'F');
      
      doc.setTextColor(255, 255, 255);
      doc.setFontSize(24);
      doc.setFont('helvetica', 'bold');
      doc.text('Urban Analytics - Porovnání návrhů', margin, 20);
      ...
      doc.text('Urban Analytics - AI-Powered Project Analysis', margin, footerY);
